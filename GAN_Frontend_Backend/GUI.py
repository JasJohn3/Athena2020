...
# TODO - BUG - GUI RESOLUTION DOES NOT REMAIN CONSISTENT ACROSS DIFFERENT SCREEN RESOLUTIONS.

import sys
from PyQt5.QtWidgets import *
from PyQt5.QtGui import QIcon, QColor, QPalette
from PyQt5.QtCore import *
import Dialogues as DialogueRail
...
class AthenaLaunchpad(QMainWindow):
    def __init__(self):
        ...
        # def initUI() <--DANGER THIS WILL BREAK THE ENTIRE GUI Potentially necessary for later build.
        ...
        self.testWindowButton = DialogueRail.TrainingDialogue()
        ...
        # ===========================================TRAIN MENU===========================================
                ...
                #TODO - add  Variable for total training label. (Total_training)
        #create a block that says if you have not entered a total training value, you cannot begin to train.
